...
class _SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    // context.bloc<ThemeBloc>().add(ChangeTheme(ThemeData(primaryColor: accentColor2)));
    // MaterialApp(theme: ThemeData().copyWith(primaryColor: accentColor2));

// print(context.bloc<ThemeBloc>().add(ChangeTheme(ThemeData().copyWith(primaryColor: accentColor2))));
