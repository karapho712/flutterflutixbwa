                    ...
                    if (snapshot.hasData) {
                      ...
                      return Column(
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        image: DecorationImage(
                                            image: NetworkImage(
                                                imageBaseUrl + "w1280" + movie.backdropPath ?? movie.posterPath),
                                            fit: BoxFit.cover)),
                                  ),
                                  Container(
                                    height: 270,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(5), color: Colors.black.withOpacity(0.04)),
                          ...
                          // RATING GOES HERE
                          RatingStars(
                              voteAverage: movie.voteAverage, color: accentColor3, alignment: MainAxisAlignment.center),
                          SizedBox(
                            height: 24,
                          ),
                          // CREDITS GOES HERE
                          ...
                          Container(
                            ...
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Text("Story Line", style: blackTextFont),
                            ),
                          ),
                          Container(
