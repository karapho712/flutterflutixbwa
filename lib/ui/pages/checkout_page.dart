...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    int total = 25000 * widget.ticket.seats.length;
                          ...
                          return Column(
                            children: <Widget>[
                              Container(
                                ...
                                child: Text("Checkout\nMovie",
                                    style: blackTextFont.copyWith(fontSize: 20), textAlign: TextAlign.center),
                              ),
                              // MOVIE DESCRIPTION
                              Row(
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      RatingStars(
                                          voteAverage: widget.ticket.movieDetail.voteAverage, color: accentColor3)
                                    ],
                                  )
                                ],
                              ),
                                    ...
                                    onPressed: () {
                                      if (user.balance >= total) {
                                        ...
                                        context.read<PageBloc>().add(
                                            GoToSuccessPage(widget.ticket.copyWith(totalPrice: total), transaction));
                                      } else {
                                        // #UANG TIDAK CUKUP
                                      }
                                    },
