                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            ...
                            style: whiteTextFont.copyWith(
                                fontSize: 16, color: !isExpiredTickets ? Colors.white : Color(0xFF6F678E)),
                          ),
                        ),
                        SizedBox(
                          height: 15,
...
class TicketViewer extends StatelessWidget {
  // const TicketViewer({ Key? key }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    // print(sortedTickets[1].theater);

    return ListView.builder(
        // padding: EdgeInsets.only(bottom: defaultMargin + 70),
        ...
        itemBuilder: (_, index) => GestureDetector(
              ...
              child: Container(
                  margin:
                      EdgeInsets.only(top: index == 0 ? 133 : 20, bottom: index == sortedTickets.length - 1 ? 100 : 0),
