                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      BlocBuilder<UserBloc, UserState>(
                        builder: (_, userState) => Column(children: <Widget>[
                          SizedBox(
                            height: 20,
                          ),
                          Text(
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                        color: Colors.black26, blurRadius: 10, spreadRadius: 0, offset: Offset(0, 5))
                                  ]),
                              child: Stack(
                                children: <Widget>[
                                  ClipPath(
                                        ...
                                        Row(
                                          children: <Widget>[
                                            Container(
                                              ...
                                              decoration:
                                                  BoxDecoration(shape: BoxShape.circle, color: Color(0xFFFFF2CB)),
                                            ),
                                            Container(
                                              width: 30,
                                              height: 30,
                                            ...
                                            Column(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  "Card Holder",
                                                  style:
                                                      whiteTextFont.copyWith(fontSize: 10, fontWeight: FontWeight.w300),
                                                ),
                                                Row(
                                                  children: <Widget>[
                                                    Text(
                              ...
                              builder: (_, snapshot) {
                                if (snapshot.hasData) {
                                  return generateTransactionList(
                                      snapshot.data, MediaQuery.of(context).size.width - 2 * defaultMargin);
                                } else {
