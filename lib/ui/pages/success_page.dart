...
class SuccessPage extends StatelessWidget {
        ...
        child: Scaffold(
          body: FutureBuilder(
            ...
            builder: (_, snapshot) => (snapshot.connectionState == ConnectionState.done)
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          ...
                          child: RaisedButton(
                            ...
                            child: Text((ticket == null) ? "My Wallet" : "My Tickets",
                ...
                : Center(child: SpinKitFadingCircle(color: mainColor, size: 50)),
          ),
        ));
  }
  ...
  Future<void> processingTicketOrder(BuildContext context) async {
    ...
    BlocProvider.of<TicketBloc>(context).add(BuyTicket(ticket, transaction.userID));
